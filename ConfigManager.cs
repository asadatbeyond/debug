...
namespace NightlyBillingConfigManager
{
    public static class ConfigManager
    {
        ...
        {
            // ASP.NET Core-style hierarchical key format for env vars / user secrets.
            string modernHierarchicalKey = $"ConnectionStrings__{configKey}";
            string primaryKey = $"NB_CONNECTION_STRING_{configKey}";
            string legacyKey = $"{configKey}_CONNECTION_STRING";

            return Environment.GetEnvironmentVariable(modernHierarchicalKey)
